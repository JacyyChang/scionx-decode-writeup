...
class IQtoOgg(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "IQtoOgg")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_short*1, 'D:\\Research\\3_SCIONX GNURadio\\1_Share\\appendix_gnuradio\\20260723_074236_100000_x.cs16', True, 0, 0)
...
def main(top_block_cls=IQtoOgg, options=None):
