...
candidates = {
    struct('wav', [OUT_DIR '20260723_091639_48k.wav'], 'segs', [2, 10, 17], ...
        'note', 'CANDIDATE ONLY -- flagged from the seg###_spec_*.png spectrogram scan, not yet decoded/verified')

    struct('wav', [OUT_DIR '20260720_220206_48k.wav'], 'segs', 7, ...
    ...
    struct('wav', [OUT_DIR '20260810_220940_48k.wav'], 'segs', [4, 18], ...
        'note', 'CANDIDATE ONLY -- flagged from the seg###_spec_*.png spectrogram scan, not yet decoded/verified')
};
